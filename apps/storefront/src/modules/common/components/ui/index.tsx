  ...
  (
    ...
    return (
      <button
        ...
        className={clsx(
          "inline-flex gap-2 items-center justify-center rounded-full font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
          variant === "primary" && "bg-sarwa-600 text-white hover:bg-sarwa-700 active:bg-sarwa-800",
          variant === "secondary" &&
            "bg-white text-sarwa-700 border border-sarwa-200 hover:bg-sarwa-50 hover:border-sarwa-300",
          variant === "transparent" && "bg-transparent hover:bg-cream-100 text-sarwa-700",
    ...
    return (
      <div className="flex flex-col gap-1">
        ...
        <input
          ref={ref}
          className={clsx(
            "flex h-10 w-full rounded-lg border border-cream-200 bg-white px-3 py-2 text-sm text-gray-900 placeholder:text-gray-500/50 focus:outline-none focus:ring-2 focus:ring-sarwa-400 focus:border-sarwa-400 focus:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 transition-colors",
            className
          )}
          {...props}
        />
